...
export const Title = () => {
  return (
    <Section background='light'>
      ...
      <span>Overall training progress : 10 ok, 3 in progress on 13</span>
      <progress class="progress is-success" value="11.5" max="13" style={{width: "400px", border: "1px black solid"}}></progress>
      <ul>
