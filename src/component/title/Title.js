...
export const Title = () => {
  return (
    <Section background='light'>
      ...
      <span>Overall training progress : 7 ok, 3 in progress on 13</span>
      <progress class="progress is-success" value="8.5" max="12" style={{width: "400px", border: "1px black solid"}}></progress>
      <ul>
        ...
        <li style={{color: "orange"}}>testing: Jest</li>
